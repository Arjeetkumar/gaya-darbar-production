 ...
 */
export function parseDateRange(dateFromStr?: string, dateToStr?: string): ParsedDateRange {
  const now = new Date();
 ...
 */
export async function getOverviewAnalytics(dateFromStr?: string, dateToStr?: string) {
  ...
  const averageOrderValue =
    stats.validOrdersCount > 0 ? Math.round(stats.totalRevenue / stats.validOrdersCount) : 0;
 ...
 */
export async function getOrderAnalytics(dateFromStr?: string, dateToStr?: string) {
  const { dateFrom, dateTo } = parseDateRange(dateFromStr, dateToStr);
 ...
 */
export async function getRevenueAnalytics(dateFromStr?: string, dateToStr?: string) {
  const { dateFrom, dateTo } = parseDateRange(dateFromStr, dateToStr);
 ...
 */
export async function getPaymentAnalytics(dateFromStr?: string, dateToStr?: string) {
  const { dateFrom, dateTo } = parseDateRange(dateFromStr, dateToStr);
 ...
 */
export async function getKitchenAnalytics(dateFromStr?: string, dateToStr?: string) {
  const { dateFrom, dateTo } = parseDateRange(dateFromStr, dateToStr);
 ...
 */
export async function getDeliveryAnalytics(dateFromStr?: string, dateToStr?: string) {
  const { dateFrom, dateTo } = parseDateRange(dateFromStr, dateToStr);
 ...
 */
export async function getRiderAnalytics(dateFromStr?: string, dateToStr?: string) {
  const { dateFrom, dateTo } = parseDateRange(dateFromStr, dateToStr);
 ...
 */
export async function getMenuPerformanceAnalytics(dateFromStr?: string, dateToStr?: string) {
  const { dateFrom, dateTo } = parseDateRange(dateFromStr, dateToStr);
 ...
 */
export async function getCustomerAnalytics(dateFromStr?: string, dateToStr?: string) {
  const { dateFrom, dateTo } = parseDateRange(dateFromStr, dateToStr);
 ...
 */
export async function getNutritionAnalytics(dateFromStr?: string, dateToStr?: string) {
  const { dateFrom, dateTo } = parseDateRange(dateFromStr, dateToStr);
  ...
  const highProteinOrderPercentage =
    Math.round((stats.highProteinItems / stats.totalItems) * 1000) / 10;
