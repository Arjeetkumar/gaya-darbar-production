...
export async function getAdminDeliveriesHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
  try {
    ...
    const result = await getAdminDeliveries({
      ...
      status: typeof status === 'string' ? (status as DeliveryStatus) : undefined,
...
export async function getAvailableRidersHandler(
  _req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function getAdminDeliveryByIdHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function assignDeliveryRiderHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function reassignDeliveryRiderHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function cancelDeliveryHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function getMyDeliveriesHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
  try {
    ...
    const deliveries = await getMyDeliveries(
      ...
      typeof status === 'string' ? (status as DeliveryStatus) : undefined
    );
...
export async function getMyDeliveryByIdHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
...
export async function updateMyDeliveryStatusHandler(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
  try {
    ...
    const updated = await updateRiderDeliveryStatus(
      deliveryId,
      req.user._id.toString(),
