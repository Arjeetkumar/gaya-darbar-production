...
export async function connectDatabase() {
    try {
        ...
        logger.warn('Development Warning: Server starting without MongoDB connection. APIs dependent on database will operate in degraded mode until MongoDB is running.');
        return false;
    }
}
