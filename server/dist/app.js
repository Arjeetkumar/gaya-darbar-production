...
import { securityHeaders, globalRateLimiter, authRateLimiter, paymentRateLimiter, } from './middleware/securityMiddleware.js';
...
export function createApp() {
    ...
    app.post('/api/v1/payments/webhook', express.raw({ type: 'application/json' }), handleWebhookHandler);
